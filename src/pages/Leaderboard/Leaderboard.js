          ...
          <Box>
               ...
               <Box sx={{ marginTop: '32px', marginBottom: '10px'}}>
                    <Stack direction='row' spacing={'9px'}>
                         <img src={`${process.env.REACT_APP_PUBLIC_URL}/assets/icon/fluent_people-32-filled.svg`} alt='people' />
                         <Typography variant='body1' color='rgba(37, 39, 63, 0.7)'>Kontributor Lain</Typography> 
                    </Stack>
               </Box>
               <Table sx={{ borderSpacing: '0px 10px'}}>
                    <CustomTableBody>
                         { topusers.slice(3).map((row, index) => <TableRow key={index}>
                              ...
                              <TableCell><span style={{ color: 'rgba(37, 39, 63, 0.4)'}}>Level {row.level}</span></TableCell>
                              <TableCell>
                         ...
                         <TableRow>
                              <TableCell colSpan={6} style={{ backgroundColor: 'transparent'}} align='center'>
