      ...
      <Grid container spacing={"85px"} alignItems="center">
          ...
          <Typography variant="title">
            ...
            <Typography variant="subtitle2">
              ...
              <span style={{ fontWeight: "700" }}>
                Tailwind, Bootstrap, dan React
              </span>
            </Typography>
          </Typography>
          <Typography variant="body1">
            Lebih dari 500+ contoh komponen yang dirancang secara profesional,
            sepenuhnya responsif, dan dibuat dengan ahli yang dapat Anda
            masukkan ke dalam proyek{" "}
            <span style={{ color: "#081A51", fontWeight: "700" }}>
              Tailwind, Bootstrap, dan React
            </span>{" "}
        ...
        <Grid item xs={12} lg={6}>
          <Box sx={{ display: "flex", justifyContent: "flex-end" }}>
            <img
              src={`${process.env.REACT_APP_PUBLIC_URL}/assets/homeicon.png`}
              alt="message"
              style={{ width: "100%" }}
            />
          </Box>
      ...
      <Grid container spacing={2} sx={{ marginTop: "42px" }}>
        ...
        <Grid item lg={3} xs={12}>
          ...
          >
            ...
            <Box sx={{ margin: "14px 48px 14px 48px" }}>
              <img
                src={`${process.env.REACT_APP_PUBLIC_URL}/assets/cards/8.png`}
                style={{ width: "100%", height: "100%" }}
                alt={`image_card_last`}
              />
            </Box>
