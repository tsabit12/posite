    ...
    <LoginContainer sx={{ padding: { lg: "0px", xs: "20px" } }}>
      ...
      <Stack spacing={"24px"}>
        <Box>
          ...
          <Typography variant="body1" color={"rgba(28, 31, 55, 0.6)"}>
            Pastikan Anda masih ingat akun Anda
          </Typography>
        </Box>
        <InputComponent
          inputProps={{
        ...
        <Typography textAlign={"center"} fontSize="16px" color={"#1C1F37"}>
          Atau
        </Typography>
        ...
        <GoogleLogin
          ...
          render={(renderProps) => (
            <GoogleButton
              startIcon={
                <img
                  src={`${process.env.REACT_APP_PUBLIC_URL}/assets/icon/google.svg`}
                  alt="google-icon"
                />
              }
