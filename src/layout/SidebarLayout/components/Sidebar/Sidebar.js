  ...
  const content = (
    ...
    >
      <Box mt={-1} ml={2} pt={3} sx={{ borderRadius: 0 }}>
        <Stack spacing={2}>
          <Typography variant="body2" color={"#51CBFF"}>
            MAIN MENU
          </Typography>
          {props.menulist.map((row, index) => (
            <MenuButton
              ...
              fullWidth
              startIcon={
                <img src={row.startIcon} alt={`${row.startIcon}${index}`} />
              }
              sx={{
                justifyContent: "flex-start",
                backgroundColor:
                  props.pathname === row.path ? activeColor : nonactiveColor,
              }}
              style={{ marginTop: "5px" }}
              component={Link}
              to={row.path}
        ...
        >
          <div>
            ...
            >
              ...
              >
                <img
                  src={`${process.env.REACT_APP_PUBLIC_URL}/assets/icon/ask.svg`}
                  alt="ask"
            ...
            <CustomPaper elevation={0}>
              ...
              <AskButton fullWidth component={Link} to="/help">
                Go to help center
              </AskButton>
            </CustomPaper>
          </div>
