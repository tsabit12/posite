...
const GradientButton = styled(Button)({
  background:
    "linear-gradient(270deg, #F3F3F3 0%, rgba(255, 255, 255, 0) 100%)",
    ...
    >
      <Toolbar disableGutters sx={{ left: 0 }}>
        ...
        <GradientButton
          ...
          endIcon={
            <img
              src={`${process.env.REACT_APP_PUBLIC_URL}/assets/icon/akar-icons_arrow-right.svg`}
              alt="arrow-right"
            />
          }
        >
        ...
        <Stack direction={"row"} alignItems="center" spacing={"35px"}>
          ...
          >
            ...
            <img
              src={`${process.env.REACT_APP_PUBLIC_URL}/assets/icon/akar-icons_chevron-down.svg`}
              alt="produk"
        ...
        <Stack spacing={"14px"}>
          <MenuItem>
            <Stack direction={"row"} spacing={"12px"} alignItems="center">
              <img
                alt="image1"
                src={`${process.env.REACT_APP_PUBLIC_URL}/assets/28.svg`}
              />
              <Box>
                <Typography variant="body2" color={"#081A51"}>
                ...
                >
                  Ada{" "}
                  <span style={{ color: "#F68407", fontWeight: "700" }}>
                    +200
                  </span>{" "}
                  library yang kami sediakan
                </Typography>
              </Box>
            </Stack>
          </MenuItem>
          ...
          <MenuItem>
            <Stack direction={"row"} spacing={"12px"} alignItems="center">
              <img
                alt="image1"
                src={`${process.env.REACT_APP_PUBLIC_URL}/assets/29.svg`}
              />
              <Box>
                <Typography variant="body2" color={"#081A51"}>
                  UI Komponen
          ...
          <MenuItem>
            <Stack direction={"row"} spacing={"12px"} alignItems="center">
              <img
                alt="image1"
                src={`${process.env.REACT_APP_PUBLIC_URL}/assets/30.svg`}
              />
              <Box>
                <Typography variant="body2" color={"#081A51"}>
                  Website Builder
