...
const NavbarRoot = styled(AppBar)({
     ...
     padding: '12px 84.5px 12px 84.5px'
})
     ...
     return(
          <NavbarRoot position="fixed">
               <Toolbar disableGutters sx={{ left: 0}}>
                    <img src='/assets/logo.png' alt='logo' style={{ width: '130px', height: '65px'}} />
                    <GradientButton
                         startIcon={<img src='/assets/icon/flat-color-icons_flash-on.svg' alt='bolt' />}
                         endIcon={<img src='/assets/icon/akar-icons_arrow-right.svg' alt='arrow-right' />}
                    >
                    ...
                    <Stack direction={'row'} alignItems='center' spacing={'35px'}>
                         <ButtonLink>
                              ...
                              <img src='/assets/icon/akar-icons_chevron-down.svg' alt='produk' style={{ marginLeft: '8px'}} />
                         </ButtonLink>
                         <ButtonLink>
